...
export default function Image({
  ...
  const generateWebPSources = (basePath: string) => {
    ...
    if (
      basePath.includes("/homepage/services/") ||
      basePath.includes("/homepage/locations/")
    ) {
      return [
        `${basePath}-320.webp 320w`,
        `${basePath}-640.webp 640w`,
    ...
    // For control-miopia, vision-pediatrica, examen-visual, and terapia-visual images, use standard responsive sizes
    if (
      basePath.includes("/control-miopia/") ||
      basePath.includes("/vision-pediatrica/") ||
      basePath.includes("/examen-visual/") ||
      basePath.includes("/terapia-visual/")
    ) {
      return [
        `${basePath}-320.webp 320w`,
        `${basePath}-640.webp 640w`,
  ...
  return (
    <picture>
      ...
      <source sizes={defaultSizes} srcSet={webpSrcSet} type="image/webp" />
