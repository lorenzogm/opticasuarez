...
test.describe("Canonical Tags Verification", () => {
  test("should have proper canonical tags on all pages", async ({ page }) => {
    ...
    const pagesToTest = [
      {
        url: "/contactologia",
        expectedCanonical: "https://opticasuarezjaen.es/contactologia",
      },
      {
        url: "/control-de-miopia",
        expectedCanonical: "https://opticasuarezjaen.es/control-de-miopia",
      },
      {
        url: "/examen-visual",
        expectedCanonical: "https://opticasuarezjaen.es/examen-visual",
      },
    ];
  ...
  test("should have proper Open Graph URLs matching canonical URLs", async ({
    page,
  }) => {
    const pagesToTest = [
      {
        url: "/contactologia",
        expectedOgUrl: "https://opticasuarezjaen.es/contactologia",
      },
      {
        url: "/control-de-miopia",
        expectedOgUrl: "https://opticasuarezjaen.es/control-de-miopia",
      },
      {
        url: "/examen-visual",
        expectedOgUrl: "https://opticasuarezjaen.es/examen-visual",
      },
    ];
