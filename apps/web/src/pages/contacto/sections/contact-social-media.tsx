      ...
      <div className="container mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="rounded-lg bg-white p-6 text-center shadow-md transition-shadow hover:shadow-lg">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-purple-600 via-pink-600 to-yellow-500">
              <svg
            ...
            <Text align="center" as="h3" className="mb-2">
              {instagram.title}
            </Text>
            <Text
              align="center"
            ...
            <Button className="w-full" href={instagram.url} variant="primary">
              Seguir
            </Button>
          </div>
          ...
          <div className="rounded-lg bg-white p-6 text-center shadow-md transition-shadow hover:shadow-lg">
            ...
            <Button className="w-full" href={facebook.url} variant="primary">
              Seguir
            </Button>
          </div>
          ...
          <div className="rounded-lg bg-white p-6 text-center shadow-md transition-shadow hover:shadow-lg">
            ...
            <Button className="w-full" href={youtube.url} variant="primary">
              Suscribirse
            </Button>
          </div>
        </div>
