...
export default function SectionSocialMedia({ section }: { section: any }) {
  const items = section.socialMediaItems || section.items || [];
          ...
          {items.map((item: any) => (
            ...
            >
              ...
              <div>
                ...
                <Text className="text-gray-600">{item.handle}</Text>
              </div>
            </div>
          ))}
        </div>
