      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center space-x-8 md:flex">
            ...
            {shopEnabled && (
              <Link
                className="relative px-2 py-2 text-gray-700 transition-colors duration-200 hover:text-blue-600"
                title="Ver carrito"
                to="/carrito"
              >
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="space-y-1 border-gray-200 border-t bg-white px-2 pt-2 pb-3">
              ...
              {shopEnabled && (
                <Link
                  className="flex items-center rounded-md px-3 py-2 font-medium text-base text-gray-700 transition-colors duration-200 hover:bg-gray-50 hover:text-blue-600"
                  onClick={closeMenu}
                  to="/carrito"
                >
                  ...
                  Carrito
                  {itemCount > 0 && (
                    <span className="ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 font-bold text-white text-xs">
                      {itemCount > 9 ? "9+" : itemCount}
                    </span>
                  )}
                </Link>
