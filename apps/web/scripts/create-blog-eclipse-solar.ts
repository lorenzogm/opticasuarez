/**
 * Create blog post: Eclipse Solar
 *
 * Usage: cd apps/web && npx tsx scripts/create-blog-eclipse-solar.ts
 *
...
const imageFiles = [
  "eclipse-solar-jaen-gafas.webp",
  "eclipse-solar-jaen-cielo.webp",
] as const;
...
async function publishToDataset(dataset: string) {
  ...
  const blogPost = buildEclipseSolarPost({
